/*
* Used to maintain a list of message items
* 
*/
...
function createnewlistdiv(){
	...
	divelement.setAttribute("id", getnewkey());
	return divelement;
}
...
function createlist(entries){
	...
	list.initialize=function(){
		...
		list.scrolldivelement.setAttribute("id", getnewkey());//font: '16pt'
